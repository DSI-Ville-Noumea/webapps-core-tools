 ...
 * @author AgileSoft.NC
 */
public class OuvreOngletEntityEvent extends Event {
	...
	public OuvreOngletEntityEvent(Entity entity, String editViewURI, Integer selectedTabIndex) {
		super("ouvreOngletEntity", null, entity);
		this.entity = entity;
