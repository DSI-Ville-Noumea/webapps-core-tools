...
class TemplateDocxTagResolverTest {
    ...
    fun testFunctions() {
        ...
        assertEquals("Valeur,  de mon, Expression", resolver.resolve("remplaceSautLigneParVigule_uneChaine", SdtBlock()))
        assertEquals("Valeur\n de mon\n Expression", resolver.resolve("remplaceViguleParSautLigne_uneChaine", SdtBlock()))
